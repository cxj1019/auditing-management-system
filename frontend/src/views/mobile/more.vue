...
const groups = [
  ...
  },
  {
    title: '业务查询',
    items: [
      { label: '项目管理', icon: 'Notebook', path: '/m/projects' },
      { label: '客户管理', icon: 'User', path: '/m/clients' },
      { label: '合同管理', icon: 'Document', path: '/m/contracts' },
      { label: '发票管理', icon: 'Postcard', path: '/m/invoices' },
      { label: '收款管理', icon: 'Money', path: '/m/collections' },
